...
import ec.edu.ups.nuevo.vista.Actualizar_Prestamo;
...
import ec.edu.ups.nuevo.vista.Buscar_Prestamo;
import ec.edu.ups.nuevo.vista.Buscar_Usuario;
import ec.edu.ups.nuevo.vista.Crear_Biblioteca;
import ec.edu.ups.nuevo.vista.Crear_Usuario;
import ec.edu.ups.nuevo.vista.Devolver_Libro;
import ec.edu.ups.nuevo.vista.Eliminar_Biblioteca;
import ec.edu.ups.nuevo.vista.Eliminar_Libro;
import ec.edu.ups.nuevo.vista.Eliminar_Prestamo;
import ec.edu.ups.nuevo.vista.Eliminar_Usuario;
import ec.edu.ups.nuevo.vista.Listar_Biblioteca;
import ec.edu.ups.nuevo.vista.Listar_Libro;
import ec.edu.ups.nuevo.vista.Listar_Usuario;
...
//Fondo
    ...
    private Listar_Usuario listar_Usuario;
    
    //Ventanas Biblioteca CRUD
    private Crear_Biblioteca crear_Biblioteca;
    private Listar_Biblioteca listar_Biblioteca;
    ...
    private Listar_Libro listar_Libro;
    ...
    public Principal() {
        ...
        controladorBiblioteca = new Biblioteca_Controlador(new LibroDAO(),new UsuarioDAO(),new PrestamoDAO(),new BibliotecaDAO());
    ...
    private void initComponents() {
        ...
        crear_biblioteca = new javax.swing.JMenuItem();
        listar_biblioteca = new javax.swing.JMenuItem();
        ...
        listar_libro = new javax.swing.JMenuItem();
        ...
        crear_biblioteca.setText("Crear Biblioteca");
        crear_biblioteca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                crear_bibliotecaActionPerformed(evt);
            }
        });
        jMenu3.add(crear_biblioteca);

        listar_biblioteca.setText("Listar Biblioteca");
        listar_biblioteca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listar_bibliotecaActionPerformed(evt);
            }
        });
        jMenu3.add(listar_biblioteca);
        ...
        listar_libro.setText("Listar Libro");
        listar_libro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listar_libroActionPerformed(evt);
            }
        });
        mnLibro.add(listar_libro);
    ...
    private void mniAgregar_UsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniAgregar_UsuarioActionPerformed
        if (crear_Usuario == null) {
            crear_Usuario = new Crear_Usuario(controladorUsuario);
    ...
    private void mniBuscar_UsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniBuscar_UsuarioActionPerformed
        ...
        buscar_Usuario.cambiarIdioma(locale);
    ...
    private void mniActualizar_UsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniActualizar_UsuarioActionPerformed
        ...
        actualizar_Usuario.cambiarIdioma(locale);
    ...
    private void mniEliminar_UsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniEliminar_UsuarioActionPerformed
        ...
        eliminar_Usuario.cambiarIdioma(locale);
    ...
    private void mniAgregar_LibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniAgregar_LibroActionPerformed
        ...
        agregar_Libro.cambiarIdioma(locale);
    ...
    private void mniBuscar_LibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniBuscar_LibroActionPerformed
        ...
        buscar_Libro.cambiarIdioma(locale);
    ...
    private void mniActualizar_LibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniActualizar_LibroActionPerformed
        ...
        actualizar_Libro.cambiarIdioma(locale);
    ...
    private void mniEliminar_LibroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mniEliminar_LibroActionPerformed
        ...
        eliminar_Libro.cambiarIdioma(locale);
    ...
    private void listar_libroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listar_libroActionPerformed
        if (listar_Libro == null) {
            listar_Libro = new Listar_Libro(controladorLibro);
            jPanel1.add(listar_Libro);
        }
        listar_Libro.cambiarIdioma(locale);
        listar_Libro.setVisible(true);
    }//GEN-LAST:event_listar_libroActionPerformed

    private void listar_usuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listar_usuarioActionPerformed
        if (listar_Usuario == null) {
            listar_Usuario = new Listar_Usuario(controladorUsuario);
            jPanel1.add(listar_Usuario);
        }
        listar_Usuario.setVisible(true);
    }//GEN-LAST:event_listar_usuarioActionPerformed

    private void crear_bibliotecaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crear_bibliotecaActionPerformed
        if (crear_Biblioteca == null) {
            crear_Biblioteca = new Crear_Biblioteca(controladorBiblioteca);
            jPanel1.add(crear_Biblioteca);
        }
        crear_Biblioteca.cambiarIdioma(locale);
        crear_Biblioteca.setVisible(true);
    }//GEN-LAST:event_crear_bibliotecaActionPerformed

    private void listar_bibliotecaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listar_bibliotecaActionPerformed
        if (listar_Biblioteca == null) {
            listar_Biblioteca = new Listar_Biblioteca(controladorBiblioteca);
            jPanel1.add(listar_Biblioteca);
        }
        listar_Biblioteca.cambiarIdioma(locale); 
        listar_Biblioteca.setVisible(true);
    }//GEN-LAST:event_listar_bibliotecaActionPerformed
    public void cambiarIdioma() {
        ...
        mniAgregar_Usuario.setText(mensajes.getString("agregarUsuario"));
        mniBuscar_Usuario.setText(mensajes.getString("buscarUsuario"));
        mniActualizar_Usuario.setText(mensajes.getString("actualizarUsuario"));
        mniEliminar_Usuario.setText(mensajes.getString("eliminarUsuario"));
        listar_usuario.setText(mensajes.getString("listarUsuario"));
        mniAgregar_Libro.setText(mensajes.getString("agregarLibro"));
        mniBuscar_Libro.setText(mensajes.getString("buscarLibro"));
        mniActualizar_Libro.setText(mensajes.getString("actualizarLibro"));
        mniEliminar_Libro.setText(mensajes.getString("eliminarLibro"));
        listar_libro.setText(mensajes.getString("listarLibro"));
        mniPrestar_Libro.setText(mensajes.getString("prestarLibro"));
        mniDevolver_Libro.setText(mensajes.getString("devolverLibro"));
        menuIdiomas.setText(mensajes.getString("idiomas"));
        menuItemEspanol.setText(mensajes.getString("español"));
        menuItemIngles.setText(mensajes.getString("ingles"));
        jMenu3.setText(mensajes.getString("biblioteca"));
        crear_biblioteca.setText(mensajes.getString("crearBiblioteca"));
        listar_biblioteca.setText(mensajes.getString("listarBiblioteca")); 
        if (crear_Usuario != null) {
            crear_Usuario.cambiarIdioma(locale);
        }
        ...
        if (listar_Usuario != null) {
            listar_Usuario.cambiarIdioma(locale);
        }
    ...
    private javax.swing.JMenuItem crear_biblioteca;
    ...
    private javax.swing.JMenuItem listar_biblioteca;
    private javax.swing.JMenuItem listar_libro;
