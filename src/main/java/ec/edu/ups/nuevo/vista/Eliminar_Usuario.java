...
public class Eliminar_Usuario extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("eliminarUsuario"));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        String id = this.llenarEspacio(txtId.getText());

        int respuesta = JOptionPane.showConfirmDialog(this, mensajes.getString("el"));
        if (respuesta == JOptionPane.YES_OPTION) {
            if (usuarioControlador.eliminar(id)) {
                JOptionPane.showMessageDialog(this, mensajes.getString("ell"));
                this.limpiarCampos();
            } else {
                JOptionPane.showMessageDialog(this, mensajes.getString("elll"));
            }
        }    
