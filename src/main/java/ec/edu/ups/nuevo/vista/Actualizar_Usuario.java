...
public class Actualizar_Usuario extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("actualizarUsuario"));
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        Usuario usuario = new Usuario(llenarEspacio(nombre), llenarEspacio(id), llenarEspacio(correo), llenarEspacio(telefono));
        usuario.setCorreo(llenarEspacio(correo));
        usuario.setIdentificacion(llenarEspacio(id));
        usuario.setNombre(llenarEspacio(nombre));
        usuario.setTelefono(llenarEspacio(telefono));
        
        if (controladorUsuario.actualizar(usuario)){
            JOptionPane.showMessageDialog(this, mensajes.getString("ac.u"));
            this.limpiarCampos();
        }else{
            JOptionPane.showMessageDialog(this, mensajes.getString("ac.uu"));
        }
