...
public class Crear_Usuario extends javax.swing.JInternalFrame {
    ...
    public Crear_Usuario(UsuarioControlador usuarioControlador) {
        initComponents();
    ...
    public void cambiarIdioma(Locale locale){
        ...
        jLabel2.setText(mensajes.getString("telefono"));
        btnCancelar.setText(mensajes.getString("cancelar"));
        btnBorrar.setText(mensajes.getString("borrar"));
        btnCrear.setText(mensajes.getString("crear"));
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("agregarUsuario"));
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if (!nombre.isEmpty() && !id.isEmpty() && !correo.isEmpty()) {
            ...
            Usuario nuevoUsuario = new Usuario(llenarEspacio(nombre), llenarEspacio(id), llenarEspacio(correo), llenarEspacio(telefono));
