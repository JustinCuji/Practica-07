...
public class Eliminar_Libro extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("eliminarLibro"));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if (!titulo.isEmpty()) {
            ...
            if (libroEliminar != null) {
                ...
                int opcion = JOptionPane.showConfirmDialog(this, mensajes.getString("eli"), "Confirmar eliminación", JOptionPane.YES_NO_OPTION);
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    if (eliminado) {
                        JOptionPane.showMessageDialog(this, mensajes.getString("e"), "Éxito", JOptionPane.INFORMATION_MESSAGE);

                        // Limpia los campos después de la eliminación
                        limpiarCampos();
                    } else {
                        JOptionPane.showMessageDialog(this, mensajes.getString("ee"), "Error", JOptionPane.ERROR_MESSAGE);
                        this.limpiarCampos();
                    }
                }
            } else {
