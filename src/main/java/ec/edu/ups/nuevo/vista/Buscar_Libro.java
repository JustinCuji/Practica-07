...
public class Buscar_Libro extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("buscarLibro"));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!titulo.isEmpty()) {
            ...
            if (libroEncontrado != null) {
                ...
                JOptionPane.showMessageDialog(this, mensajes.getString("ab.l"), "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            // Si el campo de título está vacío, muestra un mensaje de advertencia
            JOptionPane.showMessageDialog(this, mensajes.getString("ab.ll"), "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
