...
public class Agregar_Libro extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        btnAgregar.setText(mensajes.getString("agregar"));
        btnBorrar.setText(mensajes.getString("borrar"));
        btnCancelar.setText(mensajes.getString("cancelar"));
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("agregarLibro"));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        if (titulo.isEmpty() || autor.isEmpty() ) {
            ...
            try {
                ...
                Libro nuevoLibro = new Libro(llenarEspacio(titulo), llenarEspacio(autor), anio);

                // Agregar el libro a través del controlador
                libroControlador.agregarLibro(nuevoLibro);

                // Mostrar mensaje de éxito
                JOptionPane.showMessageDialog(this, mensajes.getString("ag.ll"));
