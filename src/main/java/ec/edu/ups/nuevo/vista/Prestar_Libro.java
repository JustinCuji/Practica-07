...
public class Prestar_Libro extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        jLabel2.setText(mensajes.getString("identificacion"));
        jLabel3.setText(mensajes.getString("disponible"));
        btnBuscar.setText(mensajes.getString("buscar"));
        btnCancelar.setText(mensajes.getString("cancelar"));
        btnLimpiar.setText(mensajes.getString("limpiar"));
        btnPrestarLibro.setText(mensajes.getString("prestarLibro"));
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("prestarLibro"));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!titulo.isEmpty() && !idUsuario.isEmpty()) {
            ...
            if (libro != null && usuario != null) {
                ...
                JOptionPane.showMessageDialog(this, mensajes.getString("pres"), "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(this, mensajes.getString("pre"), "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
        ...
        if (!titulo.isEmpty() && !idUsuario.isEmpty()) {
            ...
            if (libroPrestar != null && usuario != null) {
                if (libroPrestar.isDisponible()) {
                    ...
                    JOptionPane.showMessageDialog(this, mensajes.getString("pree"), "Éxito", JOptionPane.INFORMATION_MESSAGE);

                    // Limpia los campos después del préstamo
                    limpiarCampos();
                } else {
                    JOptionPane.showMessageDialog(this, mensajes.getString("p"), "Advertencia", JOptionPane.WARNING_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(this, mensajes.getString("pres"), "Error", JOptionPane.ERROR_MESSAGE);
            }
