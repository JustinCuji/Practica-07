...
public class Actualizar_Libro extends javax.swing.JInternalFrame {
    ...
    public void cambiarIdioma(Locale localizacion){
        ...
        jLabel1.setText(mensajes.getString("titulo"));
        jLabel2.setText(mensajes.getString("autor"));
        jLabel3.setText(mensajes.getString("anio"));
        jLabel4.setText(mensajes.getString("disponible"));
        ...
        Border borde = BorderFactory.createTitledBorder(mensajes.getString("actualizarLibro"));
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String titulo = this.llenarEspacio(txtTitulo.getText());
        ...
        if (!titulo.isEmpty()) {
            ...
            if (libroEncontrado != null) {
                ...
                JOptionPane.showMessageDialog(this, mensajes.getString("ac.librono"), "Error", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            // Si el campo de título está vacío, muestra un mensaje de advertencia
            JOptionPane.showMessageDialog(this, mensajes.getString("ac.titulo"), "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (!titulo.isEmpty() && !autor.isEmpty()) {
            try {
                ...
                Libro libroActualizado = new Libro(llenarEspacio(titulo), llenarEspacio(autor), anio);
                ...
                JOptionPane.showMessageDialog(this, mensajes.getString("ac.ac"), "Éxito", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(this, mensajes.getString("ac.acc"), "Advertencia", JOptionPane.WARNING_MESSAGE);
        }
